...
# You can download [this](https://biopsychkiel.github.io/datascience_in_practice/_sources/tutorials/A0-AllExercises.ipynb) notebook as a template to fill out all exercises. A complete list of tasks has to be handed in by **28.02.2023, 23:59:59** via e-mail (j.welzel@neurologie.uni-kiel.de). There is a total of 42 points, you need 17 to pass (5 you already have by just sending an empty notebook). People who did the extra advent exercise have to score *13 points* to pass. 
