...
# <a href="https://docs.conda.io/projects/conda/en/latest/user-guide/concepts/packages.html" class="alert-link">conda</a>
# package manager.
# </div>
...
# Well, of course you want to look stylish. Guess what, so does your code. Some standards have emerged in terms of code style, the most popular one bein [PEP8](https://peps.python.org/pep-0008/). [Here](https://google.github.io/styleguide/pyguide.html) is a great resource on how to be stylish and how to maintain style with your code. As in real life, it is not mandatory but might help along the way. 
